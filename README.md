...
![k-POD-result](https://github.com/iiradia/kPOD/blob/master/images/kPODExample1 (1).JPG) ![k-Means-result](https://github.com/iiradia/kPOD/blob/master/images/kMeansExample1 (1).JPG)

#### N = 100, P = 2, K = 3, 25% Missing Data

![k-POD-result](https://github.com/iiradia/kPOD/blob/master/images/kPODExample2 (1).JPG) ![k-Means-result](https://github.com/iiradia/kPOD/blob/master/images/kMeansExample2 (1).JPG)
